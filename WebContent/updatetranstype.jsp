...
<form ACTION="updatetranstype.spring" method=post>
<%Trade id=(Trade)request.getAttribute("data"); %>
<h3 style="color:white;">CUST_ID:</h3><input type="text" name="Cust_Id" value="<%=id.getCust_Id() %>" readonly="readonly"><br><br>
<h3 style="color:white;">TRANSACTION TYPE</h3>
<select required aria-required="true" name="Transaction_Type" required="True">
            <option></option>
