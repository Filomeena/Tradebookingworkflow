...
<form ACTION="updateisinid.spring" method=post>
...
<h3 style="color:white;">ISIN CODE</h3>
<select required aria-required="true" name="ISIN_Code" required="True">
            <option></option>
            <option value=1>CH0021340127</option>
            <option value=2>IN0012340126</option>
            <option value=3>US0385082406</option>
            <option value=4>UK2409569338</option>
            </select>
<br><br>
