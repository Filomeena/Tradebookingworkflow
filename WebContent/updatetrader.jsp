...
<form action="updatingTrader.spring" method="post">

<%Trade id=(Trade)request.getAttribute("data"); %>
<h3 style="color:white;display:inline">ID to update:</h3>
<input type="text" name="Trader_Id" style="align:left" value="<%=id.getTrader_Id()%>" readonly="readonly"><br><br>

<div><input type="radio" name="type" value="fname" id="radio1" class="radio"/> 

<label for="radio1">TRADER_FIRSTNAME</label></div>
<div>
<input type="radio" name="type" value="lname" id="radio2" class="radio" /> 

<label for="radio2">TRADER_LASTNAME</label></div>
<div>
<input type="radio" name="type" value="mobile_no" id="radio3" class="radio"/> 

<label for="radio3">MOBILE_NUMBER</label></div>
<br><br>
<div style="width:400px"><br><br>
<input type="submit"  value="SUBMIT" class="btn btn-success"/>
</form>
&nbsp;&nbsp;&nbsp;&nbsp;
<form action="Traderhome.jsp" method="post" style="display:inline">
