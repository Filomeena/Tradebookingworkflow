...
<form ACTION="updatelname.spring" method=post>
<%Trade id=(Trade)request.getAttribute("data"); %>
<%session.setAttribute("userId", id.getCust_Id()); %>
<h4 style="color:black;">CUST_ID:</h4><input type="text" name="Cust_Id" value="<%=id.getCust_Id() %>" readonly="readonly"><br><br>
<h4 style="color:black;">CUST_LASTNAME:</h4><input type="text" name="Cust_LastName" pattern="[A-Z][a-z]{3,40}" required
...
<input type="submit"  value="BACK" class="btn btn-success"/><br><br><br><br><br><br><br><br><br><br>.</form></div><br><br>
</body>
</html>