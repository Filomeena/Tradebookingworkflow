...
<form ACTION="updatelocationid.spring" method=post>
...
<h3 style="color:white;">LOCATION ID</h3>
<select required aria-required="true" name="Location_Id" required="True">
            <option></option>
            <option value=1>345534</option>
            <option value=2>932649</option>
</select>
<br><br>
