...
<form ACTION="updatebuysell.spring" method=post>
...
<h3 style="color:white;">BUY SELL</h3>
<select required aria-required="true" name="Buy_Sell" required="True">
            <option></option>
            <option value=1>Buy</option>
            <option value=2>Sell</option>
            </select><br><br>
<div style="width:300px">
<input type="submit" value="SUBMIT" class="btn btn-success"/></form></form>
<form id="back" action="updatingadmin.jsp" method="post" style="display: inline">&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="BACK" class="btn btn-success"/><br><br><br><br><br><br><br><br><br><br>.</form></form></div>
