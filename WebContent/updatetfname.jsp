...
<h1 style="color:white;">UPDATE RECORD</h1><br><br><br><br><br>
<form ACTION="updatetfname.spring" method=post>
<%Trade id=(Trade)request.getAttribute("data"); %>
<%session.setAttribute("traderId", id.getTrader_Id()); %>
<h4 style="color:white;display:inline">TRADER_ID:</h4><input type="text" name="Trader_Id" value="<%=id.getTrader_Id() %>" readonly="readonly"><br><br><br>
<h4 style="color:white;display:inline">TRADER_FIRSTNAME:</h4><input type="text" name="Trader_FirstName" pattern="[A-Z][a-z]{3,40}" required
